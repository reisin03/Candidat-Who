...
<div class="container">
    ...
    <div class="text-center my-4">
        <h1 class="display-6 fw-bold text-primary">Barangay Officials</h1>
    ...
    <div class="text-center mb-4">
        <h4 class="text-primary">Barangay Kagawads</h4>
    </div>
    ...
    <div class="row g-3 justify-content-center">
        ...
        <div class="col-md-6 col-lg-4 mb-3">
            <div class="card h-100 text-center border-0 shadow">
                <div class="card-body">
                    @if($kagawad->photo)
                        <img src="{{ asset('storage/'.$kagawad->photo) }}" class="rounded-circle" style="width: 60px; height: 60px; object-fit: cover;">
                    @else
