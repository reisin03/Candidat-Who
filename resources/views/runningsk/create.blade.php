...
@section('title', 'Add Running SK Official')

@section('content')
<div class="container">
    <h2 class="mb-4">Add Running SK Official</h2>
    <form action="{{ route('admin.runningsk.store') }}" method="POST" enctype="multipart/form-data">
        @csrf
        ...
        <div class="row mb-3">
            ...
            <div class="col-md-4">
                ...
                <input type="number" name="age" class="form-control" min="15" max="30" required>
            </div>
        </div>
        ...
        <div class="d-flex gap-2">
            ...
            <a href="{{ route('admin.runningsk.index') }}" class="btn btn-secondary">Cancel</a>
        </div>
    </form>
</div>
