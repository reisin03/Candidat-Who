...
<div class="container">
    ...
    <div class="text-center my-4">
        <h1 class="display-6 fw-bold text-primary">Running SK Officials</h1>
        <p class="text-muted">Meet the youth candidates running for SK office</p>
    </div>

    <!-- SK Chairperson Candidates -->
    <div class="text-center mb-4">
        <h4 class="text-primary">SK Chairperson Candidates</h4>
    </div>
    ...
    <!-- SK Members -->
    <div class="text-center mb-4">
        <h4 class="text-primary">SK Member Candidates</h4>
    </div>
