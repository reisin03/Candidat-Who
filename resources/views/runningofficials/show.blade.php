...
@section('title', 'Running Official Details')

@section('content')
<div class="container">
    <!-- Page Header -->
    <div class="text-center mb-5">
        <h1 class="fw-bold text-primary">Running Official Details</h1>
        <p class="text-muted">Detailed information about the running official.</p>
    </div>
